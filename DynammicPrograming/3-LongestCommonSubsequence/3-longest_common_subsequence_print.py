...
def print_longest_common_subsequence__memo_traverse(s1, s2):
    dp = [
    ...
    def print_longest_common_subsequence_util(n1, n2):
        ...
        if dp[n1][n2] != -1:
            ...
            dp[n1][n2] = 1 + print_longest_common_subsequence_util(n1 - 1, n2 - 1)
        else:
            dp[n1][n2] = max(print_longest_common_subsequence_util(n1 - 1, n2),
                       print_longest_common_subsequence_util(n1, n2 - 1))
        return dp[n1][n2]
    print_longest_common_subsequence_util(len(s1), len(s2))
    n1, n2 = len(s1), len(s2)
    result = []
    while n1 > 0 and n2 > 0:
        if s1[n1- 1] == s2[n2 - 1]:
...
if __name__ == "__main__":
    ...
    print(print_longest_common_subsequence__memo_traverse(s1, s2))
